...
We could continue to tweak the plot to make it look more and more like the actual published plot using nothing but `ggplot` code.  This is one of the great powers of R:  it's customizability and portable make creating professional-style graphics interactive and fun.
