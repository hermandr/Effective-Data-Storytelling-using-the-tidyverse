...
success_msg("Good work! <br> (THINK ABOUT IT:  Why are the variables in `police_locals` the specific `class` they are coded as here (`chr`, `int`, `dbl`?)")
```
...
success_msg <- "Exactly! The observational unit here is city.  Percentage of officers, police force, and race are all variables/characteristics about the city."
