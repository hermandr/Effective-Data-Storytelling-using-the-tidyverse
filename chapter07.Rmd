...
--- type:NormalExercise lang:r xp:100 skills:1 key:885a7aacb2
## Fix incorrect code
...
--- type:NormalExercise lang:r xp:100 skills:1 key:04a7b0afce
...
--- type:NormalExercise lang:r xp:100 skills:1 key:bac8392cbc
...
--- type:NormalExercise lang:r xp:100 skills:1 key:e52367fd4e
...
```{r}
library(dplyr)
birth_summ <- US_births_2000_2014 %>% 
...
--- type:NormalExercise lang:r xp:100 skills:1 key:66f450f2cf
...
geom_col_fun %>% check_arg("color") %>% check_equal(eval = FALSE)
geom_col_fun %>% check_arg("fill") %>% check_equal(eval = FALSE)
success_msg("Great work!")
test_error()
```

--- type:NormalExercise lang:r xp:100 skills:1 key:755d91471c
...
What age ranges and gender pairings have the highest and lowest proportions of thinking reclining airline seats are rude?")
test_error()
```
