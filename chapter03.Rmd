...
msg_success("Good work!  (THINK ABOUT IT:  After looking over the plot, is it the type of relationship you expected (negative, positive, not much at all, etc.)?)")
test_error()
```
...
msg_success("Nice! (THINK ABOUT IT:  What stands out to you as you look
  over this plot?  How does adding the `state_ideology` help you better understand
