...
msg_success("Nice! <br><br> THINK ABOUT IT:  What stands out to you as you look over this plot?  How does adding the
...
test_library_function("ggplot2")
test_ggplot(check_data = TRUE, check_aes = TRUE, check_geom = TRUE)
success_msg("Great work!  <br><br> THINK ABOUT IT:  How does this coloring help to understand the distribution of births across the year?  Can you identify the points that don't follow the patterns and what days they correspond to?")
test_error()
```
