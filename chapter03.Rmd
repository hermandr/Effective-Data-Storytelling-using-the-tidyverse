...
*** =instructions
- Plot `births` on the vertical axis and `date` on the horizontal axis using a point for the geometry.  Then color the points based on `day_of_week`.  (You might want to enter your code into the Console first plot without color and then add the color later after you have that working.)
